...
\
        <div class="dropdown d-none d-lg-inline-block">\
            <a class="btn header-item waves-effect" href="login.html"><i class="bx bx-power-off font-size-17 align-middle mr-1 text-danger"></i> Logout</a>\
            \
        </div>\
        <div class="dropdown d-inline-block">\
...
document.getElementById("page-topbar").innerHTML = b
